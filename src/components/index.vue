  ...
  <div class="home_body" id="home_body">
    ...
    <div class="home_bottom">
      <div class="home_botom_title_body">
        <router-link
          tag="div"
          class="home_bottom_itme"
          style="background: linear-gradient(to right bottom, rgba(253, 235, 25, 0.94), rgba(232, 5, 173, 1))"
          to="/photography"
        >
        ...
        <router-link
          tag="div"
          class="home_bottom_itme"
          style="background: linear-gradient(to right bottom, rgba(171, 236, 255, 0.94), rgba(123, 3, 255, 1))"
          to="/chronicle"
        >
        ...
        <router-link
          tag="div"
          class="home_bottom_itme"
          style="background: linear-gradient(to right bottom, rgba(251, 157, 196, 0.94), rgba(248, 216, 0, 1))"
          :to="'/world/' + mapHeight"
        >
        ...
        <router-link
          tag="div"
          class="home_bottom_itme"
          style="background: linear-gradient(to right bottom, rgba(129, 251, 184, 0.94), rgba(40, 199, 177, 1))"
          to="/about"
        >
      ...
      <div class="friendship_links">
        ...
        <router-link tag="a" class="assembly ui-link function_link" to="/home"> 专业技能 </router-link>
      </div>
    </div>
  </div>
</template>
